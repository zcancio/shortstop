...
/**
 Base class for all ShortStop views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ShortStop view hierarchy (such as wrapped iOS UIViews) was touched.
