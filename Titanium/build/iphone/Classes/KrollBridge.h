...
@interface ShortStopObject : KrollCoverageObject {
#else
@interface ShortStopObject : KrollObject {
#endif
@private
...
extern NSString * ShortStop$ModuleRequireFormat;
