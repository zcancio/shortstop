...
// in simulator we redefine to format for ShortStop Developer console
...
{\
	NSString * exceptionName = [@"org.shortstop." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.shortstop";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIShortStopNativeItemNone = -1, 
	UIShortStopNativeItemSpinner = -2,
	UIShortStopNativeItemProgressBar = -3,
	
	UIShortStopNativeItemSlider = -4,
	UIShortStopNativeItemSwitch = -5,
	UIShortStopNativeItemMultiButton = -6,
	UIShortStopNativeItemSegmented = -7,
	
	UIShortStopNativeItemTextView = -8,
	UIShortStopNativeItemTextField = -9,
	UIShortStopNativeItemSearchBar = -10,
	
	UIShortStopNativeItemPicker = -11,
	UIShortStopNativeItemDatePicker = -12,
	
	UIShortStopNativeItemInfoLight = -13,
	UIShortStopNativeItemInfoDark = -14,
	
	UIShortStopNativeItemDisclosure = -15,
	
	UIShortStopNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ShortStop instances of
