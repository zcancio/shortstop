...
//@interface ShortStopObject : NSObject
//@end

@interface ShortStopObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ShortStopObject class]])
		{
			for (NSString *key in [[(ShortStopObject*)o modules] allKeys])
			{
