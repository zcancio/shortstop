...
/**
 The base class for all ShortStop modules
 */
...
/**
 ShortStop Platform calls this method on startup.
 */
-(void)startup;

/**
 ShortStop Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ShortStop Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ShortStop Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ShortStop Platform calls this method on resume.
 @param sender The sender of the event.
 */
